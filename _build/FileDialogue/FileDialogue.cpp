...
/// </summary>
void FileBrowser::PushFileType(const wchar_t* ext, const wchar_t* desc)
{
    m_filetypes.push_back({ desc, ext });
}

void FileBrowser::PopFileType()
{
    m_filetypes.pop_back();
}

void FileBrowser::ResetFileTypes()
{
    m_filetypes.clear();
}

void FileBrowser::SetStartPath(const std::wstring& startPath)
{
...
void FileBrowser::SetDefaultExtension(const std::wstring& ext)
{
    m_saveExt = ext;
}

void FileBrowser::ClearStartPath()
{
    m_startpath = std::wstring();
}

std::wstring FileBrowser::GetFile() const
{
    CoInitialize(NULL);
    std::wstring path;
...
std::wstring FileBrowser::SaveFile()
{
    CoInitialize(NULL);
...
std::wstring FileBrowser::LoadFolderCondensed()
{
    std::wstring path;
...
std::wstring FileBrowser::LoadFolder()
{
    CoInitialize(NULL);
    std::wstring path;
